    ...
    const works = [
        {
            ...
            description3: 'Then, I created a dashboard web-app to enable shops owners to configure their account. This web-app is working with NextJS, Typescript and Tailwind CSS.',
